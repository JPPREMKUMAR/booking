    ...
    return (
        <div className=' bg-[#0D1B2A] '>
            ...
            <div className="py-3 px-3 flex items-center justify-between border-b border-slate-300 sm:hidden  ">
                <div className=' px-2'>
                    <Link to="/">
                        <img src={logo} alt="logo" loading="lazy" className="w-[130px] h-[40px]  " />
                    </Link>
                </div>
            ...
            <div className=" hidden sm:block sm:flex flex-row items-center justify-around px-6 py-4 border-b border-slate-300 font-bold">
                ...
                <div className='flex gap-x-4 items-center'>
                    ...
                    <Link to="/termsOfServices" className="hidden   px-2 text-sm text-white  text-gray-600  cursor-pointer ">
                        Services
                    </Link>
                    <Link to="/aboutUs" className="sm:hidden  px-2 text-sm text-white  text-gray-600  cursor-pointer ">
                        About Us
                    </Link>
                    <Link to="/contactUs" className="sm:hidden   px-2 text-sm text-white  text-gray-600  cursor-pointer ">
                        Contact Us
                    </Link>
                    {
